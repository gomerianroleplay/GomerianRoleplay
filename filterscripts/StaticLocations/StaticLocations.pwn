...
public SL_IsPlayerAtLocation(playerid, E_STATIC_LOCATION_TYPE:type)
{
    ...
    new player_static_location = gPlayerStaticLocation[playerid];
    ...
    new E_STATIC_LOCATION_TYPE:static_location_type = gStaticLocations[player_static_location][LOCATION_TYPE];
