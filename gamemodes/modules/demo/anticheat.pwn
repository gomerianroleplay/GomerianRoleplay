...
public OnCheatDetected(playerid, ip_address[], type, code)
{
    ...
    {
        case 0: {
            if(airbreak_anticheat{playerid}++ > 2) SendClientMessageToAllEx(X11_TOMATO_1, "Anticheat: %s have been kicked by BOT for: Airbreak Hack", ReturnName(playerid)), KickEx(playerid);
            else SendAdminMessage(X11_LIGHTSKYBLUE1, "Anticheat: %s possible onfoot airbreak hack.", ReturnName(playerid));
        }
        case 1: {
            if(vehairbreak_anticheat{playerid}++ > 2) SendClientMessageToAllEx(X11_TOMATO_1, "Anticheat: %s have been kicked by BOT for: Vehicle Airbreak Hack", ReturnName(playerid)), KickEx(playerid);
            else  SendAdminMessage(X11_LIGHTSKYBLUE1, "Anticheat: %s possible vehicle airbreak hack.", ReturnName(playerid));
        }
        case 2: {
            ...
            if(teleport_anticheat{playerid}++ > 2) 
            {
                ...
                SendClientMessageToAllEx(X11_TOMATO_1, "Anticheat: %s have been kicked by BOT for: Teleport Hack", ReturnName(playerid)), KickEx(playerid);
            }
            else 
            {
        ...
        case 3: {
            ...
            if(vehteleport_anticheat{playerid}++ > 2) SendClientMessageToAllEx(X11_TOMATO_1, "Anticheat: %s have been kicked by BOT for: Vehicle Teleport Hack", ReturnName(playerid)), KickEx(playerid);
            else SendAdminMessage(X11_LIGHTSKYBLUE1, "Anticheat: %s possible vehicle teleport hack.", ReturnName(playerid));
        }
        case 4: SendAdminMessage(X11_LIGHTSKYBLUE1, "Anticheat: %s have been kicked by BOT for: wrap vehicle hack.", ReturnName(playerid)), KickEx(playerid);
        case 5: SendAdminMessage(X11_LIGHTSKYBLUE1, "Anticheat: %s possible vehicle teleport to player hack.", ReturnName(playerid)), KickEx(playerid);
        case 6: {
            if (tele_pickup_ac[playerid] >= MAXIMUM_REPORTED_CHEAT)
            {
                SendAdminMessage(X11_LIGHTSKYBLUE1, "Anticheat: %s have been kicked by BOT for: teleport to pickup hack.", ReturnName(playerid));
                KickEx(playerid);
            }
            else
            {
        ...
        case 7: {
            if(flyhack_anticheat{playerid}++ > 2) SendClientMessageToAllEx(X11_TOMATO_1, "Anticheat: %s have been kicked by BOT for: Fly Hack", ReturnName(playerid)), KickEx(playerid);
            else  SendAdminMessage(X11_LIGHTSKYBLUE1, "Anticheat: %s possible fly hack.", ReturnName(playerid));
        }    
        case 8: {
            if(vehflyhack_anticheat{playerid}++ > 2) SendClientMessageToAllEx(X11_TOMATO_1, "Anticheat: %s have been kicked by BOT for: Vehicle Fly Hack", ReturnName(playerid)), KickEx(playerid);
            else SendAdminMessage(X11_LIGHTSKYBLUE1, "Anticheat: %s possible vehicle fly hack.", ReturnName(playerid));
        }
        case 10: SendAdminMessage(X11_LIGHTSKYBLUE1, "Anticheat: %s have been kicked by BOT for: vehicle speed hack.", ReturnName(playerid)), KickEx(playerid);
        case 11: 
        {
            new Float:health;
            ...
            if(vehhealthhack_anticheat{playerid}++ > 2) SendClientMessageToAllEx(X11_TOMATO_1, "Anticheat: %s have been kicked by BOT for: Vehicle Health Hack", ReturnName(playerid)), KickEx(playerid);
            else SendAdminMessage(X11_LIGHTSKYBLUE1, "Anticheat: %s possible vehicle health hack.", ReturnName(playerid));
        }
        case 12: 
        {
            new Float:health;
            ...
            if(healthhack_anticheat{playerid}++ > 2) SendClientMessageToAllEx(X11_TOMATO_1, "Anticheat: %s have been kicked by BOT for: Health Hack", ReturnName(playerid)), KickEx(playerid);
            else SendAdminMessage(X11_LIGHTSKYBLUE1, "Anticheat: %s possible health hack.", ReturnName(playerid));
        }
        case 13: 
        {
            new Float:armor;
            ...
            if(armourhack_anticheat{playerid}++ > 2) SendClientMessageToAllEx(X11_TOMATO_1, "Anticheat: %s have been kicked by BOT for: Armour Hack", ReturnName(playerid)), KickEx(playerid);
            else SendAdminMessage(X11_LIGHTSKYBLUE1, "Anticheat: %s possible armour hack.", ReturnName(playerid));
        }//MarkhereAC
        ...
        case 18: SendAdminMessage(X11_LIGHTSKYBLUE1, "Anticheat: %s have been kicked by BOT for: using special animations hack.", ReturnName(playerid));
