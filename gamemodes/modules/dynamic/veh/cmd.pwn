	...
	switch(action)
	{
		...
		case 12: // Siren
		{
			...
			if((vehicle_index = Vehicle_ReturnID(vehicleid)) != RETURN_INVALID_VEHICLE_ID)
			{
				...
				new veh_id = CreateVehicle(VehicleData[vehicle_index][vehModel], VehicleData[vehicle_index][vehPosX], VehicleData[vehicle_index][vehPosY], VehicleData[vehicle_index][vehPosZ], VehicleData[vehicle_index][vehPosRZ], VehicleData[vehicle_index][vehColor1], VehicleData[vehicle_index][vehColor2], -1, bool:siren);
