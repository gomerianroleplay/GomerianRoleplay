...
// Variables
new trash_collected[MAX_PLAYERS] = {0, ...},
...
Dialog:StartTrashmaster(playerid, response, listitem, inputtext[])
{
    if (response)
    {
        ...
        new max_trashes_collected = JobConfig_GetMaxTrashes();

        trash_progressbar[playerid] = CreatePlayerProgressBar(playerid, 37.000000, 319.000000, 102.500000, 7.199999, -1429936641, 100.0000, progressbar_direction:0);
