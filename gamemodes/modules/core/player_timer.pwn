...
ptask Player_TextdrawUpdate[1000](playerid)
{
    ...
    if(!PlayerData[playerid][pTogHud])
    {
        ...
        PlayerTextDrawSetString(playerid, PlayerTextdraws[playerid][textdraw_timegui][1], outputDate);
    }
    if(!PlayerData[playerid][pPhone])
    {
        ...
        // PlayerTextDrawSetString(playerid, PhoneTimeMinimize[playerid], sprintf("%d:00", ServerData[ServerTime]));
    }
    else if(PlayerData[playerid][pPhone])
    {
    ...
    // {
    //     PlayerTextDrawSetString(playerid, RelationshipTD[playerid][3], sprintf("Single"));
    // }
    // else if(PlayerData[playerid][pStatus] == 1)
    // {
    //     PlayerTextDrawSetString(playerid, RelationshipTD[playerid][3], sprintf("Dating"));
    // }
    // else if(PlayerData[playerid][pStatus] == 2)
    // {
    //     PlayerTextDrawSetString(playerid, RelationshipTD[playerid][3], sprintf("Married"));
    // }
    return 1;
}
...
ptask Player_JailUpdate[1000](playerid)
{
    ...
    if(PlayerData[playerid][pJailTime] > 0)
    {
        ...
        if(--PlayerData[playerid][pJailTime] <= 0)
        {
            ...
            // outjail
            SetPlayerPos(playerid,1549.7559,-1675.5649,15.1064);
            SetPlayerFacingAngle(playerid, 90.4652);
