...
OpenATM(playerid, bool:paycheck = false)
{
    if(paycheck == true)
    {
        PlayerTextDrawSetString(playerid, BankMoneyVisual[playerid], sprintf("%s", FormatNumber(PlayerData[playerid][pBankMoney])));
        PlayerTextDrawShow(playerid, LayerPertama[playerid]);
        PlayerTextDrawShow(playerid, LayerKedua[playerid]);
        PlayerTextDrawShow(playerid, ATMVisual[playerid]);
        PlayerTextDrawShow(playerid, WithdrawButton[playerid]);
        PlayerTextDrawShow(playerid, TransferButton[playerid]);
        PlayerTextDrawShow(playerid, PaycheckButton[playerid]);
        PlayerTextDrawShow(playerid, AccountBalanceVisual[playerid]);
        PlayerTextDrawShow(playerid, SalaryButton[playerid]);
        PlayerTextDrawShow(playerid, BankMoneyVisual[playerid]);
        PlayerTextDrawShow(playerid, ATMCloseButton[playerid]);
