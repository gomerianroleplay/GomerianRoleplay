...
public OnPlayerConnect(playerid)
{
	...
	PlayerSkin[playerid] = CreatePlayerTextDraw(playerid, 227.000000, 117.000000, "Preview_Model");
	...
	FactionRankName[playerid] = CreatePlayerTextDraw(playerid, 360.000000, 190.000000, "Chief Of Police - 0000014045");
	...
	PlayerName[playerid] = CreatePlayerTextDraw(playerid, 360.000000, 173.000000, "Revelt DeOrtiz");
